namespace ReverseTicTacToe.Logic
{
    ...
    public class ReverseTicTacToeGame
    {
        ...
        public void UpdateStatusGame(BoardCell i_PlayerMove, out eInputValidationCheck io_TurnStatusAtBoardGame)
        {
            io_TurnStatusAtBoardGame = doPlayerMove(i_PlayerMove);
